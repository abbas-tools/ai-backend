...
# Cloudinary Configuration (Aapke diye gaye credentials yahan set hain)
cloudinary.config(
    cloud_name='a0ec1nvp',
...
# ==============================================
# ROUTE: Admin Panel (Cloudinary Upload)
# ==============================================
  ...
  if request.method == 'POST':
    if 'file' in request.files:
      ...
      if file.filename != '':
        ...
        try:
          # Cloudinary ke 'ahb_file_hub' folder mein file upload hogi
...
# ==============================================
# ROUTE: Delete File (Cloudinary Delete)
# ==============================================
